(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper-image")) new swiper_core_Swiper(".swiper-image", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    function initSlidersTwo() {
        if (document.querySelector(".slider-categories")) new swiper_core_Swiper(".slider-categories", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 6,
            ...
            grabCursor: true,
            navigation: {
                prevEl: ".categories__arrow_left",
                nextEl: ".categories__arrow_right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
    ...
    document.addEventListener("scroll", (function(ev) {
        ...
        if (window.scrollY) headerEl.classList.add("header-scroll"); else headerEl.classList.remove("header-scroll");
    }));
